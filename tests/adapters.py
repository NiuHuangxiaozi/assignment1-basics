...
def run_cross_entropy(
    ...
    """
    niu_cross_entropy_loss = NIUCrossEntropyLoss()
    return niu_cross_entropy_loss(inputs, targets)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return cosine_scheduling(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
